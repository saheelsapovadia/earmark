...
<a href=''  className="inline-flex items-center hover:text-indigo-400">
...
<h1 className="text-first leading-first md:text-sec md:leading-sec  font-body font-semibold mb-8">
Healthy spending made
<span className="text-purple-500"> effortlessly.</span>
</h1>
<p className="text-lg mb-8">
Less Robinhood YOLOs, and more strategic planning around your goals.
Better budgeting tools and wealth tracking across all your accounts.
</p>

<form >
<div className="bg-white rounded-full py-1 pr-1 pl-6 mb-6 shadow-input">
<label  className="absolute -m-px w-px h-px overflow-hidden whitespace-nowrap border-0">Enter email address...</label>
<div className="flex items-center">
<input type="email" placeholder="Enter email address..." id="email" name="email" className="outline-none flex-1 bg-transparent min-w-0" />
<button type="submit" className="submit flex items-center flex-none bg-yellow-200 rounded-full py-4 px-5 sm:px-7 ml-4">
<span className="hidden sm:block text-sm">Join waitlist</span
                  >
<span className="sm:hidden text-sm">Waitlist</span>
<span className="block ml-2 w-3 h-3">
<img alt="Right arrow icon" className="arrow" width="12" height="12" src={arrow} />
</span>
</button>
</div>
</div>
...
<p>
<small className="text-sm text-gray-400">We won&rsquo;t sell or spam your email. Scouts honour.</small
              >
</p>
</form>
</section>
...
<img alt="Mock up of the earmark application" loading="lazy"  src={app1x} className="sm:max-w-none h-auto" width="875" height="779" />
</div>
...
<span className="text-sm text-purple-600">Secure management</span>
</p>
...
Connect once, we&rsquo;ll handle the rest securely. No more digging
through accounts to find that transaction from last week.
</p>
</div>


<div className="col-span-4 justify-self-end self-end col-start-1 row-start-3 md:transform translate-x-12">
<img alt="Illustration of a woman on a swing" loading="lazy" width="512" className="max-w-full h-auto sm:max-w-none" height="481" src={swing} />
</div>
</div>
</div>
...
<p className="text-lg -mt-1.5">
You&rsquo;ll be kept in the loop to manage unexpected charges before
they show up on your next bill.
</p>
</div>
...
<img alt="Monthly budget graphing showing a balance" loading="lazy" 
               src={chart1x} className="max-w-none h-auto" width="629" height="420" />
</div>
...
<img alt="" loading="lazy" width="196" height="158" className="absolute transform -translate-x-1/2 -translate-y-1/2" src={dots} />
<article className="flex flex-col relative">
<img alt="Ryan Johnson headshot avatar" loading="lazy" src={ryan1x} className="self-center sm:self-start lg:self-center rounded-full mb-6" width="64" height="64" />
<p className="text-xl leading-2v font-semibold mb-8">
&ldquo;This will seriously be a game changer. Get ready for the best
thing to come to your finances.&rdquo;
</p>
<p className="text-lg leading-v "><strong>Ryan Johnson</strong></p>
<p className="text-lg leading-v">Principal Product Design, Dribbble</p>
</article>
</blockquote>
</section>
...
<p className="text-lg mb-6 -mt-1">
We&rsquo;re big believers in paying yourself first. Set automated
transfers between accounts and banks to make your pay work for
you.
</p>
<p className="text-lg -mt-1.5 mb-10">
Quickly create and cancel transfers to align with your investment
goals.
</p>
<ul className="flex justify-between items-center mb-4">
<li>
<img alt="Wells fargo logo" loading="lazy" width="50" height="50" src={wellsfargo} />
</li>
<li>
<img alt="Citi logo" loading="lazy" width="62" height="40" src={citi} />
</li>
<li className="hidden lg:block">
<img alt="Capital One logo" loading="lazy" width="111" height="40" src={captialone} />
</li>
<li className="block sm:hidden md:block">
<img alt="TD logo" loading="lazy" width="53" height="48" src={td} />
</li>
<li>
<img alt="Bank of America logo" loading="lazy" width="68" height="68" src={bankofamerica} />
</li>
<li className="hidden xl:block">
<img alt="RBC logo" loading="lazy" width="50" height="50" src={rbc} />
</li>
</ul>
...
<p className="text-lg -mt-1.5 mb-10">
Better yet, view trendlines for specific accounts to better inform
future decisions.
</p>
</article>
</section>
...
<img alt="Illustration of woman holding a plant" loading="lazy" width="493" height="461" className="max-w-full h-auto sm:max-w-none sm:transform sm:translate-x-24 sm:translate-y-6" src={growing} />
</div>
</div>
</div>
...
We can&rsquo;t wait to show you what Earmark can do. Be the first
